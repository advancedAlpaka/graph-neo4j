...
Например можно ввести вместо первого и второго реактивов просто множество реактивов, а вместо продукта ввести просто множество продуктов реакции.(что я и сделал) Тогда можно будет представлять различные реакции, в том числе обмена или разложения, в то время как схема выше предлагает только реакции соединения. 